  ...
  return (
    <div className={`flex flex-col ${className}`}>
      ...
      <input
        ...
        type={type}
        className={`text-text-light-sec dark:bg-gray-9 dark:text-gray-3 bg-gray-05 border border-gray-3 dark:border-gray-4 p-2 rounded-md focus:outline-1 focus:outline-gray-2 dark:focus:outline-gray-4 ${inputClasses}`}
        ref={ref}
